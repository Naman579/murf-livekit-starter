    ...
    default: {
      ...
      return (
        <MotionAgentAudioVisualizerBar
          ...
          {...props}
        >
          {/* 🎯 Dots Ki Size Badi Kardi Hai (min-h-5 w-5 = 20px) */}
          <span className="min-h-5 w-5 rounded-full bg-current/10 transition-colors duration-250 ease-linear data-[lk-highlighted=true]:bg-current" />
        </MotionAgentAudioVisualizerBar>
      );
    }
  }
